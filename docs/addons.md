This file was generated by `npm run listing` command at 2021年9月1日 20:34 JST.
...
|iss_sr_direction_straight_right|ja:[一方通行] 直進と右折舗装<br>en:[One way] Go straight and turn right pavement|roadsign|road|N/A|
|iss_sr_direction_left_straight|ja:[一方通行] 直進と左折<br>en:[One way] Go straight and turn left|roadsign|road|N/A|
...
|name|translate|obj|waytype|system_type|
|---|---|---|---|---|
|iss_wsg_round_about|ja:[3x3] ラウンドアバウト<br>en:[3x3] Round about|way|tram_track|0|
